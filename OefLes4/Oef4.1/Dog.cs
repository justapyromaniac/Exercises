...
namespace OefLes4.Oef4._1
{
    class Dog : Pet
    {
        public enum BehaviourTypes { agressive, docile }

        public enum EarTypes { @short, @long }

        public BehaviourTypes Behaviour { get; set; }

        public EarTypes Ears { get; set; }
        ...
        public override string ToString()
        {
            ...
            output.AppendLine($"Ears: {Ears}");
            output.AppendLine($"Behaviour: {Behaviour}");
